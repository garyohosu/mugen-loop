...
5. docs/note-draft.md への追記案を作る
   ...
   - 直接反映してよいもの: 誤字脱字修正、1〜数文程度の補足、既存方針に沿った説明の追加、
     参考情報の短い追記、表現の軽微な整理(QandA.md Q20)
   - 提案にとどめ、人間の判断を待つもの: 見出し構成の大幅変更、段落の大規模移動、
     既存記述の削除、結論や主張の変更、記事タイトルの変更、外部公開に影響する断定表現の追加
   - 「人間がレビューする前提」は、小さな追記は事後レビュー、大きな変更は事前レビューとする
